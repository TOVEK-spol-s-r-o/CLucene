...
mt.exe -manifest \DevLibs\manifest\msVC80_amd64.manifest -outputresource:\Build\win64\winR\clucene-contribs-lib.dll;2

echo Patching manifest of clucene-core.dll 
mt.exe -manifest \DevLibs\manifest\msVC80_amd64.manifest -outputresource:\Build\win64\winR\clucene-core.dll;2

echo Patching manifest of clucene-shared.dll 
mt.exe -manifest \DevLibs\manifest\msVC80_amd64.manifest -outputresource:\Build\win64\winR\clucene-shared.dll;2
